...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    lazy var fetchedResultsController: NSFetchedResultsController = {
        ...
        fetchRequest.sortDescriptors = [NSSortDescriptor(key: Person.Keys.Name, ascending: true)]
    ...
    func insertNewObject(sender: AnyObject) {
        _ = Person(dictionary: [Person.Keys.Name: "Fish", Person.Keys.Age: 23], context: sharedContext)
        saveContext()
    }
    ...
    func configureCell(cell: UITableViewCell, atIndexPath indexPath: NSIndexPath) {
        ...
        cell.textLabel!.text = "\(actor.name), age \(actor.age)"
    }
